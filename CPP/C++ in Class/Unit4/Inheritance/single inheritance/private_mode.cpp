...
class details : private employee
{
private:
    int salary;
...
public:
    ...
    void show__more_data()
    {
        ...
        cout << dept << endl;
            ...
            /*  here the important difference bw the private and protected mode is that we can inherit the items in the child class 
            but we cant access for the child of the child class  */

// class imps : private details 
// {
// private:
//     int salary;
